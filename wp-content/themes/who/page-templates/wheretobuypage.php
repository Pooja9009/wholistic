...
// window.initMap = initMap;
        ...
        <div class="map-block">
            ...
            <div class="map-second-block">
                ...
                <div id="googleMap" style="width:100%;height:400px;"></div>
                    ...
                    <!-- <iframe src="https://www.google.com/maps/d/embed?mid=1izjUukUhEWLxpWiWfzHT6_RIZmyG400&ehbc=2E312F"
                        width="675" height="350"></iframe> -->
                        <!-- AIzaSyBTEaysBVRAMjbhHabNCoXpEBbzs9HcBSI -->
    ...
    <script>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTEaysBVRAMjbhHabNCoXpEBbzs9HcBSI&callback=myMap"></script>
    </body>
</main><!-- #main -->
<?php
get_footer();

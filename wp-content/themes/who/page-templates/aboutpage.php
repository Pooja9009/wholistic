            ...
            <div class="row flex-reverse">
              <div class="content">
                ...
                <p>Dr. Traj created Wholistic as a nod to where we began – it’s founded on the belief
                    ...
                    best.</p>
                    <p>We want you to know what it feels like to feel great from the inside out.<h3> We’re Wholistic
                    – it’s lovely to meet you.</h3></p>
              </div>
                <img class="image" src="<?php bloginfo("template_directory"); ?>/img/zincTablet2.png" />
            </div>
        </div>
        <div class="about-second-banner"style="background-image:url('<?php bloginfo("template_directory"); ?>/img/aboutBanner2.png')">
        <div class="about-second-bannerContent">
        <h3>ACHIEVING WHOL(ISTIC) WELLNESS</h3>
        <p>Countless reasons can lead you to the beginning of your supplement journey: injury or illness prevention, slowing down the effects of aging, boosting energy levels or supplementing specialized dietary needs. Or it might simply be to level-up your health! </p>
        <p>Whatever brought you to us – Wholistic is here to help you complete your wellness journey and experience better health from within.</p>
</div>
</div>
...
<img src="<?php bloginfo("template_directory"); ?>/img/whoLogoSmall.png">
        ...
        <p>No half-truths or pseudoscience here - just evidence-based formulas that ungergo through quality checks and
            the Health Canada stamp of aaproval. Find supplements that will help you achieve your wellness hoals and
